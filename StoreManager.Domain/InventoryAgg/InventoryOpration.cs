...
namespace StoreManager.Domain.InventoryAgg
{
    public class InventoryOpration : EntityBase
    {
        ...
        public long CourrentCount { get; private set; }
        public string Description { get; private set; }
        //RelationShip
        public Inventory inventory { get; private set; }

        public InventoryOpration(long invantoryId, long count, bool serviceInput, long character, string description, long courrentCount)
        {
